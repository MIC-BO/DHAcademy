...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="mt-5 text-right">Find Enrollments by Student</h1>
      </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-9">
          <form:form method="post" action="/findAssignmentByStudent" modelAttribute="student">
    ...
    <c:if test="${assignments != null}">
      ...
      <%@ include file="templates/listOfAssignments.jsp" %>
    </c:if>
  </div>
